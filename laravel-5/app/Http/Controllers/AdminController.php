...
class AdminController extends Controller {
    ...
    */
    ...
    public function save_event()
    {
        ...
        $event->init_at = new \date("YYYY:mm:dd hh:mm:ss",strtotime( Input::get('init_at')));// Input::get('init_at');
        $event->end_at =  new \date("YYYY:mm:dd hh:mm:ss",strtotime( Input::get('end_at')));
