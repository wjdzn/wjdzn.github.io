                    ...
                    @foreach ($users as $user)
                    	<tr>
            				...
            				<td>
                                ...
                                <a href="{{ route('confirm_delete', $user->email) }}" data-toggle="modal" data-target="#delete_confirm"><i class="livicon" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete user"></i></a>
                            </td>
            			</tr>
                    @endforeach
