...
<head>
    ...
    <!-- end of global js-->
    <!-- page level styles-->
    <link href="{{ asset('/plugins/AdminJhon/css/pages/500.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="error-container">
                <div class="error-main">
                    ...
                    <h3>
                        ...
                        <a href="{{ route('dashboard') }}" class="btn btn-responsive button-alignment btn-warning" style="margin-bottom:7px;" role="button">Home</a>
                    <br>
                </div>
            </div>
        </div>
