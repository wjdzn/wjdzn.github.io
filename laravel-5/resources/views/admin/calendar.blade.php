...
//            }],
                    ...
                    drop: function(date, allDay) { // this function is called when something is dropped
                        ...
                        alert(allDay);
                        var data={all_day:allDay?1:0,name: $(this).html(),init_at:date.toLocaleDateString() , end_at:date.toLocaleDateString(),backgroundcolor:$(this).css("background-color"),  _token:  $('meta[name="csrf-token"]').attr('content')}
                        $.ajax({
                            type: "POST",
