                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('product_new') }}" method="POST" id="wizard" enctype="multipart/form-data">
                                <!-- CSRF Token -->
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="stock_amount" name="stock_amount" type="number" placeholder="Stock Amount" class="form-control required" value="{{{ Input::old('stock_amount') }}}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tax_value" class="col-sm-2 control-label">Tax</label>
                                        <div class="col-sm-10">
                                            <input id="tax_value" name="tax_value" type="number" placeholder="Taxes" class="form-control" value="{{{ Input::old('tax_value') }}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="valid_at" name="valid_at" type="text" placeholder="Valid At" class="form-control" data-mask="9999-99-99" value="{{{ Input::old('valid_at') }}}"  placeholder="yyyy-mm-dd"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
