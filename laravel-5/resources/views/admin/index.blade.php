...
<link rel="stylesheet" media="all" href="{{ asset('/plugins/AdminJhon/vendors/jvectormap/jquery-jvectormap.css') }}" />
<link rel="stylesheet" href="{{ asset('/plugins/AdminJhon/vendors/animate/animate.min.css') }}">
<link rel="stylesheet" href="{{ asset('/plugins/AdminJhon/css/only_dashboard.css') }}" />
...
<!--  todolist-->
<script src="{{ asset('/plugins/AdminJhon/js/todolist.js') }}"></script>
<!-- EASY PIE CHART JS -->
